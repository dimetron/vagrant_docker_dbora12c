...
sudo  su -c "DOCKER_TMPDIR=$DOCKER_TMPDIR && docker export java | docker import - oracle/java"
sudo docker kill java && docker rm java
...
sudo  su -c "DOCKER_TMPDIR=$DOCKER_TMPDIR && docker export weblogic | docker import - oracle/weblogic"
sudo docker kill weblogic && docker rm weblogic
...
sudo  su -c "DOCKER_TMPDIR=$DOCKER_TMPDIR && docker export database | docker import - oracle/database"
